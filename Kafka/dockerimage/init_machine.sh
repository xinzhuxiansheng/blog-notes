...
/usr/bin/wget http://containerfiles.corpxxxxx.com/ci-config/kafka/kafka_2.12-2.2.1.tar.gz -N -P /data/sysdir/servers/
...
/usr/bin/wget http://containerfiles.corpxxxxx.com/ci-config/kafka/server_nginx_test.properties -N -P /data/sysdir/servers/kafka_2.12-2.2.1/config/
